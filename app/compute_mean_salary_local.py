...
def main():
    # Initialize Spark Session in local mode first
    ...
    try:
        print("=" * 60)
        print("SPARK LOCAL MODE MEAN SALARY COMPUTATION")
        print("=" * 60)
        
        # Read the CSV file
        csv_path = "/home/thuannd/Repository/aio2025-spark-cluster/app/data/large_dataset.csv"
        ...
        # Compute mean salary
        print("\nComputing mean salary using Spark...")
